...
urlpatterns = [
    ...
    path('services-categories/create/', views.service_category_create, name='service_category_create'),
    path('services-categories/edit/<int:pk>/', views.service_category_edit, name='service_category_edit'),
    path('services-categories/delete/<int:pk>/', views.service_category_delete, name='service_category_delete'),
