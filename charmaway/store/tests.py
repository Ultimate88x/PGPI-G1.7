...
def test_home_view_excludes_services_department(client, db):
    """Test that home view excludes products from Services department"""
    # Create Services department
    ...
    # Create product in Services department
    ...
    assert service_product not in featured_products
